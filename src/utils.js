...
exports.zip =
  exports.shuffle =
  exports.incrementDups =
  exports.gridify =
  exports.generateAnswerObjs =
  exports.epoch =
  exports.chunk =
    void 0;
...
var shuffle = function (array, seed) {
  ...
  return array
    .map(function (value) {
      return { value: value, sort: randomFloat() };
    })
    .sort(function (a, b) {
...
var generateAnswerObjs = function (_a) {
  var allAnswers = _a.allAnswers,
    gameDate = _a.gameDate;
  ...
  var yesterdaysAnswerObj =
    allAnswers[(daysSinceEpoch - 1) % allAnswers.length];
  return {
    todaysAnswerObj: todaysAnswerObj,
    yesterdaysAnswerObj: yesterdaysAnswerObj,
  };
};
